...
public class Map {
	...
	public void changeWorld() {
		getLayer(LIGHT_COLLISION_LAYER_NAME).setVisible(state.getState() == WorldType.LIGHT);
		getLayer(DARK_COLLISION_LAYER_NAME).setVisible(state.getState() == WorldType.DARK);
	}
