...
public enum TextureType {
	PlayerJump(0,0,4,"player.png"),PlayerIdle(4,0,4,"player.png"),PlayerRun(8,0,4,"player.png");
	...
	TextureType(int rowBeginIndex, int colBeginIndex, int nbFrame, String fileName){
